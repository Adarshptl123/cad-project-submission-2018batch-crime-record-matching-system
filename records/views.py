...
def criminal(request):
    ...
    template=loader.get_template('criminal_list.html')
...
def compare_faces(request):
    ...
    s3=boto3.client('s3')
    obj1 = s3.get_object(Bucket='crmsfc1',Key = "s3://crmsfc1/uploadcriminal/1.jpg")
    ...
    template=loader.get_template('comparefaces.html')
    context={
